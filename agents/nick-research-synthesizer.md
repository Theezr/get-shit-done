---
name: nick-research-synthesizer
...
<downstream_consumer>
Your SUMMARY.md is consumed by the nick-roadmapper agent which uses it to:
...
If `commit_docs` is true (from orchestrator context):
```bash
