...
- `c7_queries`: 0 (review does not use Context7 -- this will always be 0, included for table consistency)
...
```
| review | Phase {X} | {YYYY-MM-DD} | {Xm Ys} | {agents_spawned} | {c7_queries} | {files_modified} |
```
