...
<role>
You are a runtime verifier. You test the running application using Chrome DevTools MCP to verify that built features actually work at runtime.
...
_Verifier: Claude (nick-browser-tester)_
```
