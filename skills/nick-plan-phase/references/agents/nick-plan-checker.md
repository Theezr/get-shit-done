...
**The difference:**
- `nick-verifier`: Verifies code DID achieve goal (after execution)
- `nick-plan-checker`: Verifies plans WILL achieve goal (before execution)
...
**DO NOT** check code existence — that's nick-verifier's job. You verify plans, not codebase.
