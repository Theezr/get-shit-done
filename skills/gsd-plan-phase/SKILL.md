...
```
Task(
  prompt="First, read ~/.claude/skills/gsd-plan-phase/references/agents/gsd-planner.md for your role and instructions.
...
```
Task(
  prompt="First, read ~/.claude/skills/gsd-plan-phase/references/agents/gsd-plan-checker.md for your role and instructions.
